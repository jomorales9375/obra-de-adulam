          ...
          <div className="max-w-5xl mx-auto relative flex flex-col lg:flex-row items-center lg:items-start">
            ...
            <div className="hidden lg:block flex-shrink-0 absolute right-0 top-1/2 transform -translate-y-1/2 z-0 pr-8" style={{width: '288px', height: '576px'}}>
              <svg width="288" height="576" viewBox="0 0 288 576" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.96436 40.5964C4.96436 18.1756 23.1493 0 45.5808 0H244.382C266.813 0 284.998 18.1748 284.998 40.5964V535.404C284.998 557.824 266.813 576 244.382 576H45.5808C23.1489 576 4.96436 557.825 4.96436 535.404V40.5964Z" fill="#DAE3EA"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M115.083 22.1018C116.578 22.1018 117.79 20.8901 117.79 19.3955C117.79 17.9008 116.578 16.6891 115.083 16.6891C113.587 16.6891 112.375 17.9008 112.375 19.3955C112.375 20.8901 113.587 22.1018 115.083 22.1018Z" fill="#BBC8D4"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M177.814 23.906C180.307 23.906 182.327 21.8866 182.327 19.3954C182.327 16.9043 180.307 14.8849 177.814 14.8849C175.322 14.8849 173.301 16.9043 173.301 19.3954C173.301 21.8866 175.322 23.906 177.814 23.906Z" fill="#BBC8D4"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M129.976 17.5912H160.213C161.21 17.5912 162.018 18.3991 162.018 19.3955C162.018 20.3919 161.21 21.1997 160.213 21.1997H129.976C128.979 21.1997 128.17 20.3919 128.17 19.3955C128.17 18.3991 128.979 17.5912 129.976 17.5912Z" fill="#BBC8D4"/>
                <path d="M2.96265 117.05C2.96265 116.551 3.36665 116.147 3.86501 116.147H5.21916V158.998H3.86501C3.36665 158.998 2.96265 158.594 2.96265 158.095V117.05Z" fill="#BBC8D4"/>
                <path d="M2.96265 170.725C2.96265 170.227 3.36665 169.823 3.86501 169.823H5.21916V212.673H3.86501C3.36665 212.673 2.96265 212.269 2.96265 211.771V170.725Z" fill="#BBC8D4"/>
                <path d="M2.96265 75.1013C2.96265 74.6029 3.36665 74.1989 3.86501 74.1989H5.21916V97.6539H3.86501C3.36665 97.6539 2.96265 97.2499 2.96265 96.7516V75.1013Z" fill="#BBC8D4"/>
